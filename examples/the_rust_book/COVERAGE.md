...
Compositional example refresh: 2026-08-29.
...
| 13 | `ch13_closures_iterators.py` | Copy/non-Copy/domain iterators and typed Rayon pipelines | split anonymous locals, owned Vec<Shoe>, parallel index capability | Complete |
...
- `tests/unit/test_collection_algebra.py`, `tests/unit/test_iterators.py`, and
  ...
  and 13 compositions
- `tests/integration/test_native_etl_acceptance.py` and
