...
| R-016 | Python runtime calls spread through native code and erase performance/safety value. | 4 | 4 | 16 | Most call graphs contain PythonRuntimeBoundary; users cannot see why. | First-class effects, warn/deny policy, inspect counts, GIL access only at boundaries, native alternatives in diagnostics/docs. | Language/product | M3 onward |
